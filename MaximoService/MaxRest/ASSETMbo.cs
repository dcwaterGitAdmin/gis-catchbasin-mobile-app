...
namespace DCWaterMobile.MaximoService.MaxRest
{
    public partial class ASSETMbo
    {
        ...
        public static List<string> GetCreateAttributeNames()
        {
            return new List<string>() {"ASSETTAG", "DESCRIPTION", "SITEID", "ORGID","FAILURECODE","STATUS",
                                       "CLASSSTRUCTUREID","STATUS","GLOBALID", "EQ10", "LOCATION",
                                       "MANUFACTURER", "MAPNUM", "QUAD", "WARD", "PLUSSFEATURECLASS","PLUSSISGIS","EQ3","ISRUNNING"};
        }
    ...
    /// <remarks/>
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("GEOWORXSYNCID")]
    ...
    public partial class ASSETGLACCOUNT
    {

        private string vALUEField;

        private ASSETGLACCOUNTGLCOMP gLCOMPField;
        ...
        /// <remarks/>
        public ASSETGLACCOUNTGLCOMP GLCOMP
        {
            get
            {
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true, Namespace = "http://www.ibm.com/maximo")]
    public partial class ASSETGLACCOUNTGLCOMP
    {
